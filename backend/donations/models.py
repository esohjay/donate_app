...
class UserProfile(models.Model):
    ...
    phone = models.CharField(
        "Phone Number", max_length=14, null=True, blank=True, unique=True
    )
    email = models.CharField(
        "Email address", max_length=50, null=True, blank=True, unique=True
    )
    ...
    searchRadius = models.IntegerField("Product search radius in km", default=15)
...
class Item(models.Model):
    ...
    transaction_type = models.CharField(
        "Offer type",
        default="",
        choices=[("Offer", "Giver"), ("Request", "Recipient")],
        max_length=50,
    )
    cordinates = models.PointField(blank=True, null=True)
